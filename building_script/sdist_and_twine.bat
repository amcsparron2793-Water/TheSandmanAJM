...
set project_full_path="%pyprojects_root%\TheSandmanAJM"
...
REM move the dir instead of copying - suppresses all output
...
echo removing TheSandmanAJM.egg-info directory
rmdir /S /Q TheSandmanAJM.egg-info